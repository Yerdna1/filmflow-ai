...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-cinematic p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2">
            <Film className="h-10 w-10 text-primary" />
            <span className="text-2xl font-bold">FilmFlow AI</span>
          </Link>
        ...
        <p className="text-center text-xs text-muted-foreground mt-8">
          ...
          <Link href="/terms" className="underline">podmienkami používania</Link>
          {' '}a{' '}
          <Link href="/privacy" className="underline">ochranou súkromia</Link>.
        </p>
      </div>
    </div>
  )
